...
# soundb = freq_plot.extract_audio("Reg1.mp4")
# b0 = freq_plot.read_audio("Reg1WAV.wav")
# b1 = b0[:44100*50]
# b2 = freq_plot.process_audio(b1, 1024, 1024*.25)
# b3 = freq_plot.pairs(b2)
# b5 = freq_plot.freq_list(b3)
# # b4 = sorted(b2.items(), key=lambda x: x[1])
# # plot_d(b2)

# soundc = freq_plot.extract_audio("Reg2.mp4")
# c0 = freq_plot.read_audio("Reg2WAV.wav")
# c1 = b0[44100*5:44100*20]
# c2 = freq_plot.process_audio(c1, 1024, 1024*.25)
# c3 = freq_plot.pairs(c2)
# c5 = freq_plot.freq_list(c3)
# # plot_d(c2)
# # compare(c3, b3, 5, 20)


# start_points = freq_plot.find_start(b5, c5, 7, 70)
# print "start points:", start_points
# alignment = freq_plot.best_start(b5, c5, start_points)
# print "alignment: ", alignment
# secs = c3[alignment][1]  # must be longer sample
# print "sec: ", secs
